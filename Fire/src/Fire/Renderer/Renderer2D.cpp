#include "frpch.h"
#include "Fire/Renderer/Renderer2D.h"
...
namespace Fire {
 	...
 	struct QuadVertex
 	{
       ...
       struct Renderer2DData
       {
              ...
              static const uint32_t MaxTextureSlots = 16;             // TODO: RenderCaps (was 32, will only run at 16 on my mac!)
 	...
 	void Renderer2D::Init()
 	{
 		...
 		s_Data.WhiteTexture = Texture2D::Create(1, 1);
              ...
              s_Data.TextureShader = Shader::Create("/Users/jsb/Dropbox/Documents/Fire/Sandbox/assets/shaders/Texture.glsl");
 	...
 	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const glm::vec4& color, float rotation)
 	{
              ...
              _DrawQuad(position, size, textureIndex, textureCoords, rotation, tilingFactor, color);
 	}
       ...
       void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const Ref<SubTexture2D>& subtexture, float rotation, float tilingFactor, const glm::vec4& tintColor)
       {
              DrawQuad({ position.x, position.y, 0.0f }, size, subtexture, rotation, tilingFactor, tintColor);
       }

       void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<SubTexture2D>& subtexture, float rotation, float tilingFactor, const glm::vec4& tintColor)
       {
       ...
       void Renderer2D::_DrawQuad(const glm::vec3& position, const glm::vec2& size, float textureIndex, const glm::vec2* textureCoords, float rotation, float tilingFactor, const glm::vec4& tintColor)
       {
              ...
              if ( rotation != 0.0f )
                     Mrotate = glm::rotate(Mrotate, rotation, glm::vec3(0, 0, 1));
