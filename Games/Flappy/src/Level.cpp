...
void Level::Init()
{
	m_TriangleTexture = Texture2D::Create("/Users/jsb/Dropbox/Documents/Fire/Games/Flappy/assets/textures/Triangle.png");
	m_Player.LoadAssets();
...
void Level::OnUpdate(Fire::Timestep ts)
{
...
void Level::OnRender()
{
	...
	{
		Renderer2D::DrawQuad(pillar.TopPosition, pillar.TopScale, m_TriangleTexture, glm::radians(180.0f), 1.0f, color);
		Renderer2D::DrawQuad(pillar.BottomPosition, pillar.BottomScale, m_TriangleTexture, 0.0f, 1.0f, color);
	}
