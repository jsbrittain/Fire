...
{
	m_ShipTexture = Texture2D::Create("/Users/jsb/Dropbox/Documents/Fire/Games/Flappy/assets/textures/Ship.png");
}

void Player::OnUpdate(Fire::Timestep ts)
{
	m_Time += ts;

	if (Input::IsKeyPressed(FR_KEY_SPACE))
	{
...
void Player::OnRender()
{
	...
	Renderer2D::DrawQuad({ m_Position.x, m_Position.y, 0.5f }, { 1.0f, 1.3f }, m_ShipTexture, glm::radians(GetRotation()) );
}
